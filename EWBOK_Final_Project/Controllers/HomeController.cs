...
namespace EWBOK_Final_Project.Controllers
{
    public class HomeController : Controller
    {
        public ActionResult Index() 
        {
            ...
            ViewBag.NewProduct = new ProductDao().ListProductByNew(4);
            ViewBag.BestViewProduct = new ProductDao().ListProductByViewCount(4);
            ViewBag.DiscountProduct = new ProductDao().ListProductByDisCount(3);
            ViewBag.BestSellerProduct = new ProductDao().ListProductByBestSeller(3);
            ViewBag.WishProduct = new ProductDao().LisProductByWishCount(3);
